...
public :
    ...
    // assume 'b' is the newly insert node whose parent is 'a'
    ...
    bool operator()(ListNode* a, ListNode* b) {
        ...
        if (b->val < a->val) {
            // you need a swap to build a minHeap based on ListNode's value
            return true;
        }
...
// time :  nklogk (nk push + nk pops into the minHeap)
